...
@interface FMGVideoPlayView()<CFDanmakuDelegate,LoaderURLConnectionDelegate>
...
//    
//    AVPlayerItem *item = [AVPlayerItem playerItemWithAsset:_videoURLAsset];
//    self.currentItem          = item;
//    
//    if (!self.player) {
//        
